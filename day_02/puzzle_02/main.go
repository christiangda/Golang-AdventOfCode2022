...
import (
	...
	"github.com/christiangda/Golang-AdventOfCode2022/day_02/puzzle_02/shapes"
)
...
func init() {
	flag.StringVar(&input, "input", "input.txt", "input: a file path with the content of your https://adventofcode.com/2022/day/2/input")
...
func main() {
	...
	for rc.Scan() {
		...
		p2 := shapes.GetShapeFromStrategy(p1Token, p2Token)
		if p1 == nil {
